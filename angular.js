/**
 * @license AngularJS v1.2.16-ng-repeat-exec-order
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.16-ng-repeat-exec-order/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.16-ng-repeat-exec-order',    // all of these placeholder strings will be replaced by grunt's
  major: 1,    // package task
  minor: 2,
  dot: 16,
  codeName: 'ng-repeat-exec-order'
};
